...
function M.cmd_info(opts)
    opts = extend_tbl({
        ...
        surround = {
            ...
            condition = function()
                return
                    condition.is_hlsearch() or condition.is_macro_recording() or
        ...
        on_click = {
            ...
            callback = function(...)
                ...
                if args.sign and args.sign.name and
                    env.sign_handlers[args.sign.name] then
...
function M.builder(opts)
    ...
    return opts.surround and
               status_utils.surround(opts.surround.separator,
                                     opts.surround.color, children,
                                     opts.surround.condition) or children
end
